...
import com.example.moviecollection.view.MovieDetailsActivity;
import com.example.moviecollection.view.NowPlayingActivity;
...
public class NowPlayingAdapter extends RecyclerView.Adapter<NowPlayingAdapter.CardViewViewHolder>{
    ...
    public void onBindViewHolder(@NonNull CardViewViewHolder holder, int position) {
        ...
        holder.lbl_release_date.setText("Released " + results.getRelease_date());
